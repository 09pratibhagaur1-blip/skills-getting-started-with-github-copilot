...
activities = {
    ...
    "Music Ensemble": {
        "description": "Rehearse music pieces and perform for the school community",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["liam@mergington.edu", "rachael@mergington.edu"]
    },
    "Science Club": {
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["ethan@mergington.edu", "ariana@mergington.edu"]
    }
}
